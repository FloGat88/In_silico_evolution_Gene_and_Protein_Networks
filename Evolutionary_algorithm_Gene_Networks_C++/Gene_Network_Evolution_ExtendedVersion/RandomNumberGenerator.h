...
extern uniform_real_distribution<double> randdouble;
extern uniform_real_distribution<float> randfloat;
...
inline short ChooseInd_respective_weights(short weights[], short size)
{
    short sum = 0;
    short i,d;
